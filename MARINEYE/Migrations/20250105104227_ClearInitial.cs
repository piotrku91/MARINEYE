...
{
    /// <inheritdoc />
    public partial class ClearInitial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubDueTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClubDueTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClubDueTransactions_ClubDueModel_ClubDueId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharterDueTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CharterDueTransactions_BoatCalendarEventModel_BoatCalendarEventId",
                        column: x => x.BoatCalendarEventId,
                        principalTable: "BoatCalendarEventModel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharterDueTransactions_BoatCalendarEventId",
                table: "CharterDueTransactions",
                column: "BoatCalendarEventId");

            migrationBuilder.CreateIndex(
                name: "IX_ClubDueTransactions_ClubDueId",
                table: "ClubDueTransactions",
                column: "ClubDueId");

            migrationBuilder.CreateIndex(
                name: "IX_ClubDueTransactions_UserId",
                table: "ClubDueTransactions",
                column: "UserId");
        }
