...
namespace MARINEYE.Migrations
{
    ...
    [Migration("20241228165948_Dues2")]
    partial class Dues2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MARINEYE.Areas.Identity.Data.MARINEYEUser", b =>
                {
            ...
            modelBuilder.Entity("MARINEYE.Models.DueTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MARINEYE.Areas.Identity.Data.MARINEYEUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
